    ...
    internal static class FontPickerCatalogService
    {
        ...
        internal static SKTypeface CreateTypefaceFromDescriptor(string familyName, FontStyleDescriptor descriptor)
        {
            return descriptor == null
                ? SkiaTypefaceService.CreateTypeface(familyName, 400, (int)SKFontStyleWidth.Normal, SKFontStyleSlant.Upright)
                : SkiaTypefaceService.CreateTypeface(familyName, descriptor.Weight, descriptor.Width, descriptor.Slant);
        }
